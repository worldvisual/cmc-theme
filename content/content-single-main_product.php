    ...
    <div class="product-menu">
      ...
      <div class="product-menu-data">
        ...
        <div class="product-menu-features">
          ...
          <?php endif; ?>
          <span>
            <?php _e($data['transaction']); ?>

          </span>
          <span>
            <?php _e($data['capacitance']); ?>
          </span>
        </div>
      </div>
      <div class="clear"></div>
  ...
  <div class="product-grid-2">
    <div class="product-header">
      <div class="product-header_content">
        ...
        <div class="product-facebook fb-share-button" data-href="<?php _e(get_the_permalink()); ?>" data-layout="button" data-size="large" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php _e(get_the_permalink()); ?>&src=sdkpreparse"><?php _e('Compartir'); ?></a></div>
        <div class="product-data">
          ...
          <?php if (get_post_type() == 'main_product') : ?><div><label><?php _e('Tipo:'); ?></label><span><?php  _e($data['type']); ?></span></div><?php endif; ?>
        ...
        <a rel="nofollow" class="aawp-button aawp-button--buy aawp-button aawp-button--amazon aawp-button--icon aawp-button--icon-amazon-black product-button-2" href="<?php _e(esc_url($data['affiliate-link'])); ?>"><?php _e($data['button-text']); ?></a>
    ...
    <?php if (get_post_type() == 'main_product') : ?>
      <div class="related-products">
        ...
        <?php
        _e(cmc_related_products('main_product', 'product-category', get_the_terms(get_the_ID(), 'product-category')[0]->slug, get_the_ID()));
        ?>
      </div>
    <?php endif; ?>
    <?php if (comments_open() || get_comments_number()) : comments_template();
  endif; ?>
  <?php if (comments_open() || get_comments_number()) : _e($options['theme_legal_comments']['value']);
endif; ?>
</div>
