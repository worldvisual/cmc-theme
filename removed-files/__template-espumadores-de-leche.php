<?php
/*
	Template Name: Listar Espumadores de leche
		...
		<div id="primary" class="primary without-sidebar">
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				<div class="entry-header">
					<h1><?php _e('Todos los Espumadores de Leche');?></h1>
				</div>
			...
			<div class="clear"></div>
			<input type="hidden" id="cmcPostType" value="related_product_2">
